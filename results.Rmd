...
I then wanted to mitigate other potentially influential factors such as income and education. I used the ANOVA test to control for education first, and then education and income. I have lm() written in the R section of this page, but for some reason it is not translating to the website. The website shows an earlier version of the page. 
